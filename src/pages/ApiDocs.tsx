...
export default function ApiDocs({ user }: ApiDocsProps) {
  ...
  return (
    <Layout user={user}>
      <Head title='API Documentation | My CMS' />
      ...
      <div className='w-full space-y-12 pb-24'>
        ...
        <div className='space-y-4'>
          ...
          <p className='text-xl text-muted-foreground max-w-3xl'>
            Everything you need to integrate My CMS with your frontend
...
curl -X GET "${baseUrl}/api/collections/site-settings/entries" \\
  -H "Authorization: Bearer YOUR_API_KEY"`}
        ...
        <section id='forms' className='space-y-6 scroll-mt-20'>
          ...
          <p className='text-muted-foreground'>
            Submit data from your frontend forms directly into My CMS. This
  ...
  -H "X-Tenant-ID: YOUR_TENANT_ID"`}
        ...
        >
          ...
          <CodeBlock
            ...
            copiedId={copied}
            onCopy={copyToClipboard}
            code={`const MY CMS_API_URL = "${baseUrl}/api";
const API_KEY = "your_secret_api_key";

async function getBlogPosts() {
  const response = await fetch(\`\${MY CMS_API_URL}/collections/blog-posts/entries\`, {
    headers: {
