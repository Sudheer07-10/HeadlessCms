...
export default function EntriesList({
      ...
      fields?.forEach((f) => {
        if (f.type === 'text') obj[f.name] = `Sample ${f.label || f.name}`
          ...
          const sampleMedia = {
            id: 10,
            filename: 'image.jpg',
            secureUrl: 'https://storage.my-cms.com/tenants/1/image.jpg',
            mimeType: 'image/jpeg',
            size: 204800,
            width: 1200,
            height: 800,
          ...
          const sampleDoc = {
            ...
            fileUrl: 'https://storage.my-cms.com/tenants/1/document.pdf',
            size: 1048576,
          }
  ...
  return (
    <Layout user={user} title={`${collection.name} Entries | My CMS`}>
                                ...
                                code={JSON.stringify(
                                  {
                                    ...
                                    mimeType: 'image/jpeg',
                                    size: 524288,
                                    secureUrl: 'https://storage.my-cms.com/tenants/1/banner.jpg',
