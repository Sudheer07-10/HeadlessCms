...
export default function EditForm({ form, user }: EditProps) {
  ...
  const { data, setData, put, processing, errors } = useForm({
    ...
    theme: form.theme || {
      themeColor: 'emerald',
      headerImageUrl: '',
      customHeaderText: 'My CMS Form',
      customFooterText: 'Powered by My CMS',
    },
  })
  ...
  return (
    <Layout user={user} title={`Edit ${form.name} | My CMS`}>
            ...
            {data.storageType === 'external' ? (
              ...
              <div className='bg-primary/5 p-6 rounded-xl border border-primary/20 space-y-3 animate-in fade-in slide-in-from-right-2 duration-300'>
                ...
                <p className='text-xs text-muted-foreground'>
                  Submissions will be saved directly into your My CMS
