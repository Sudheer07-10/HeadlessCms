  ...
  return async (c: Context, next: Next) => {
    ...
    c.set(
      ...
      (
        ...
        const pageTitle = mergedProps.title || 'My CMS - Modern Headless CMS'
        ...
        if (component === 'Home') {
          badgeHtml = `
            <div style="display: none;">
              <a href="https://postyourstartup.co/startup/my-cms?ref=badge" target="_blank">
                <img src="https://postyourstartup.co/api/badge/my-cms?theme=light" alt="Featured on PostYourStartup" width="212" height="55" />
              </a>
            </div>
          `
        }
        ...
        <body class="bg-background text-foreground">
            <div id="app" data-page='${JSON.stringify(inertiaProps).replace(/'/g, '&apos;')}'>
              <div id="inertia-loading" style="height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; font-family: sans-serif; background: #1a1a1a; color: #fff;">
                ...
                <p style="margin-top: 24px; font-weight: 600; letter-spacing: 0.05em; text-transform: uppercase; font-size: 14px;">My CMS</p>
