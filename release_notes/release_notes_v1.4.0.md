# My CMS Release Notes - v1.4.0

We are excited to release **My CMS v1.4.0**! This release expands My CMS into a more complete multi-tenant cloud platform, with subscription-aware plans, stronger workspace controls, webhook observability, richer public content tools, and a more capable developer API.
