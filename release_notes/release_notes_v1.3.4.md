# My CMS Release Notes - v1.3.4

We are pleased to release **My CMS v1.3.4**! This patch update improves responsive behavior on the landing page and aligns the admin interface form previews with actual backend routing.
