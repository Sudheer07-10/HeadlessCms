# My CMS Release Notes - v1.3.3

We are thrilled to release **My CMS v1.3.3**! This update focuses on enhancing developer documentation, styling the homepage playground sandbox, and implementing a new Changelog portal.
